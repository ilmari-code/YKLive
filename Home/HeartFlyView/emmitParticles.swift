...
func emmitParticles(from point: CGPoint, emitter: CAEmitterLayer , in rootView:UIView) {
    ...
    rocket.emissionLongitude = CGFloat(CGFloat.pi/2)
    ...
    rocket.emissionRange = CGFloat(CGFloat.pi/4)
    rocket.color = UIColor(displayP3Red: 0.5, green: 0.5, blue: 0.5, alpha: 0.8).cgColor
    rocket.redRange = 0.5
    ...
    flare.emissionLongitude = 4 * CGFloat(CGFloat.pi/2)
    flare.scale = 0.4
    flare.velocity = 100;
    flare.birthRate = 45;
    flare.lifetime = 1.5;
    flare.yAcceleration = -350;
    flare.emissionRange = CGFloat(CGFloat.pi / 7)
    ...
    firework.emissionRange = CGFloat(CGFloat.pi * 2)
